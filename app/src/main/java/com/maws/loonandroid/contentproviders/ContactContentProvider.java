...
public class ContactContentProvider extends ContentProvider  {
    ...
    private static UriMatcher buildUriMatcher(){
        ...
        matcher.addURI(AUTHORITY, BASE_PATH, CONTACT);
        matcher.addURI(AUTHORITY, BASE_PATH + "/#", CONTACT_ID);
        return matcher;
    }
    ...
    public Cursor query(Uri uri, String[] projection, String selection,
        ...
        // Set the table
        queryBuilder.setTables(ContactDao.TABLE_NAME);
        ...
        switch (uriType) {
            ...
            case CONTACT_ID:
                ...
                queryBuilder.appendWhere(ContactDao.KEY_ID + "="
    ...
    public String getType(Uri uri) {
        return LoonDataType.CONTACT.toString();
    }
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        switch (uriType) {
            case CONTACT:
                id = sqlDB.insert(ContactDao.TABLE_NAME, null, values);
                break;
            default:
                throw new IllegalArgumentException("Unknown URI: " + uri);
        }
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        switch (uriType) {
            case CONTACT:
                rowsDeleted = sqlDB.delete(ContactDao.TABLE_NAME, selection,
                        selectionArgs);
                break;
            case CONTACT_ID:
                String id = uri.getLastPathSegment();
                if (TextUtils.isEmpty(selection)) {
                    rowsDeleted = sqlDB.delete(ContactDao.TABLE_NAME,
                            ContactDao.KEY_ID + "=" + id,
                            null);
                } else {
                    rowsDeleted = sqlDB.delete(ContactDao.TABLE_NAME,
                            ContactDao.KEY_ID + "=" + id
    ...
    public int update(Uri uri, ContentValues values, String selection,
        ...
        switch (uriType) {
            case CONTACT:
                rowsUpdated = sqlDB.update(ContactDao.TABLE_NAME,
                        values,
                        selection,
                        selectionArgs);
                break;
