 ...
 */
public class DeviceEnabledPropertyContentProvider extends ContentProvider {
    ...
    private static final String AUTHORITY = "com.maws.loonandroid.contentproviders.DeviceEnabledPropertyContentProvider";
    private static final String BASE_PATH = "devices";
    public static final Uri CONTENT_URI = Uri.parse("content://" + AUTHORITY + "/" + BASE_PATH);

    public static final String CONTENT_TYPE = ContentResolver.CURSOR_DIR_BASE_TYPE
            + "/deviceEnabledProperties";
    ...
    public Cursor query(Uri uri, String[] projection, String selection,
        ...
        // Set the table
        queryBuilder.setTables(DeviceEnabledPropertyDao.TABLE_NAME);
        ...
        switch (uriType) {
            ...
            case DEVICE_ID:
                ...
                queryBuilder.appendWhere(DeviceEnabledPropertyDao.KEY_ID + "="
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        switch (uriType) {
            case DEVICE:
                id = sqlDB.insert(DeviceEnabledPropertyDao.TABLE_NAME, null, values);
                break;
            default:
                throw new IllegalArgumentException("Unknown URI: " + uri);
        }
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        switch (uriType) {
            case DEVICE:
                rowsDeleted = sqlDB.delete(DeviceEnabledPropertyDao.TABLE_NAME, selection,
                        selectionArgs);
                break;
            case DEVICE_ID:
                String id = uri.getLastPathSegment();
                if (TextUtils.isEmpty(selection)) {
                    rowsDeleted = sqlDB.delete(DeviceEnabledPropertyDao.TABLE_NAME,
                            DeviceEnabledPropertyDao.KEY_ID + "=" + id,
                            null);
                } else {
                    rowsDeleted = sqlDB.delete(DeviceEnabledPropertyDao.TABLE_NAME,
                            DeviceEnabledPropertyDao.KEY_ID + "=" + id
    ...
    public int update(Uri uri, ContentValues values, String selection,
        ...
        switch (uriType) {
            case DEVICE:
                rowsUpdated = sqlDB.update(DeviceEnabledPropertyDao.TABLE_NAME,
                        values,
                        selection,
                        selectionArgs);
                break;
    ...
    private void checkColumns(String[] projection) {
        String[] available = {
                ...
                DeviceEnabledPropertyDao.KEY_PROPERTY_ID
        };
        if (projection != null) {
